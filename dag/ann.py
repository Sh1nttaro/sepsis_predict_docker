...
def main(file_path):
    ...
    try:
        ...
        model = build_and_compile(X_train.shape[1])
        ...
        # Записываем параметры и метрики в MLflow
        mlflow.log_params(
            {"input_dim": X_train.shape[1], "epochs": 100, "batch_size": 32}
        )
        mlflow.log_metrics(
            {
        ...
        # Зарегистрируем модель в MLflow.
...
# Путь к файлу
file_path = "../dataset/sepsis-predict.xls"
main(file_path)
